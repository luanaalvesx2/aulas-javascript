...
Objetos tambem são estruturas de dados só que **não-indexados**, ou seja o acesso aos dados é feito de forma diferente do que vimos nos arrays. No obejeto, acessamos através de **propriedades** e **valores** declarados através do objeto.

Normalmente, o objeto é programdo de acordo com algum contexto relacionado ao mundo real.